...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_baseline_select/log/train_save_trans_data_3"
	...
	while True:
		...
		if TRAINING_MODE != 2:
			...
			for i in range(len(pc_data)):
				...
				mean_cur_pc = cur_pc.mean(axis = 0)
				cur_pc = cur_pc - mean_cur_pc
				#np.savetxt("hehe01.txt",cur_pc,fmt="%.3f",delimiter=",")
				#print(cur_pc.shape)
				...
				#np.savetxt("hehe02.txt",pc_data[i],fmt="%.3f",delimiter=",")
